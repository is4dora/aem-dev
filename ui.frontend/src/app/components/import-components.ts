 ...
 */
MapTo('aem-dev/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('aem-dev/components/separator')(SeparatorV1Component);

MapTo('aem-dev/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('aem-dev/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('aem-dev/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('aem-dev/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('aem-dev/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('aem-dev/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('aem-dev/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('aem-dev/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('aem-dev/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('aem-dev/components/accordion')(AccordionV1Component);
MapTo('aem-dev/components/tabs')(TabsV1Component);
...
LazyMapTo('aem-dev/components/teaser')(TeaserV1Component);
...
LazyMapTo('aem-dev/components/carousel')(CarouselV1Component);
...
LazyMapTo('aem-dev/components/text')(LazyTextModule, TextEditConfig);